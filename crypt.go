...
// given a password string, a salt, and some scrypt params, populate the given
// byte slices with the scrypt-generated bytes. the slices are populated
// first-to-last, consuming the generated bytes first-to-last as they're
// populated.
